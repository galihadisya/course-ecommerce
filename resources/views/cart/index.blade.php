...
<div class="container">
    ...
    @if ($carts->count() == 0)
    <p style="text-align:center;"><marquee bgcolor="yellow">YOUR CART IS EMPTY</marquee></p>
    @endif
<div>
...
<form action="/checkout" method="POST" style="margin-left: 700px;" class="needs-validation" novalidate>
    @csrf
